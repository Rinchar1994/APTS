...
@app.route('/password/<user>', methods = ['POST', 'GET'])
def password(user):
...
def input():
    if request.method == 'POST':
        return render_template('p_input.html')
    return render_template('input.html')

@app.route('/p_input', methods = ['POST', 'GET'])
def p_input():
    if request.method == 'POST':
        return redirect(url_for('p_input'))
    return render_template('p_input.html')

@app.route('/input_init', methods = ['POST', 'GET'])
def input_init():
    if request.method == 'POST':
        return redirect(url_for('input_init'))
    return render_template('input_init.html')
